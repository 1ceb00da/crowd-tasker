...
public class SeekBarPreference extends Preference implements
	...
	private static final String USCNS="http://usc.edu";
	...
	private void setValuesFromXml(AttributeSet attrs) {
		mMaxValue = attrs.getAttributeIntValue(USCNS, "max", 50);
		mMinValue = attrs.getAttributeIntValue(USCNS, "min", 1);
		
		mUnitsLeft = getAttributeStringValue(attrs, USCNS, "unitsLeft", "");
		String units = getAttributeStringValue(attrs, USCNS, "units", "");
		mUnitsRight = getAttributeStringValue(attrs, USCNS, "unitsRight", units);
		
		try {
			String newInterval = attrs.getAttributeValue(USCNS, "interval");
			if(newInterval != null)
